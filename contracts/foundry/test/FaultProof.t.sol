...
contract FaultProofTest is Test {
    ...
    function setUp() public {
        ...
        faultProof = new FaultProof(
            ...
            96000,
            100,
            address(0x61EEd5eE968506eB27320FD776Fe14E4842b1990),
            bytes32(
                0x00acd5cddbbdda151f677cad2eebe5c0a104c2c7a0514d209fa992ef0a461bd7
            )
        );
        ...
        modelRegistry.registerModel(
            ...
            "0x010000000000000001000000000000001c000000000000001c00000000000000",
            bytes32(
                0xf0c4b404383d6a9cf9cd220237b3c5dad9e410e7fdca48ac58f66e94b5c31624
            ),
            5
        );
        ...
        modelRegistry.requestInference(
            ...
            bytes32(
                0x923edd4e1f7ea9f2641c09e4dd2bf672e09970eec48cac0f484c3f6657f7c044
            )
        );
    }
    ...
    function test_FaultProofCorrect() public {
        ...
        modelRegistry.respondInference(
            ...
            bytes32(
                0x86e1c59c8509db81bd563c58bb57d487f9cb8f23a1bc4d2b4cf6614977fa94d7
            )
        );
